...
"""autogenerated by genpy from navigation_msgs/EmergencyStop.msg. Do not edit."""
import sys
...
class EmergencyStop(genpy.Message):
  _md5sum = "f0ed97528fd0e784408fb431ee7d153c"
  _type = "navigation_msgs/EmergencyStop"
...
string frame_id
"""
  __slots__ = ['header','emergency_stop']
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_get_struct_B().pack(self.emergency_stop))
