        ...
        while notAtDestination == True:
            ...
            try:
                ...
                if text == "Auto cart" or text == "Auto Parts" or text == "Auto Part" or text == 'Alucard' or text == 'Olive Garden' or text == "Auto carton" or text == 'Albuquerque' or text == 'Elkhart' or text == "autocorrect":
                    ...
                    playsound('C:\\Users\\Jake\\Music\\Speech Recognition\\ping in.mp3')
                    ...
                    try:
                        ...
                        for x in range(len(text)):
                            ...
                            if text[x] == 'help' or text[x] == 'emergency' or text[x] == 'stroke' or text[x] == 'attack' or text[x] == 'stop':
                                 ...
                                 playsound('C:\\Users\\Jake\\Music\\Speech Recognition\\Emergency.mp3')
                                 ...
                                 try:
                                     ...
                                     playsound('C:\\Users\\Jake\\Music\\Speech Recognition\\ping out.mp3')
...
def beginRide():
    ...
    if inCart == True:
        playsound('C:\\Users\\Jake\\Music\\Speech Recognition\\enter.mp3')
    else:
        pass
...
def endRide():
    ...
    if atDestination == True:
        playsound('C:\\Users\\Jake\\Music\\Speech Recognition\\exit.mp3')
    else:
        pass
